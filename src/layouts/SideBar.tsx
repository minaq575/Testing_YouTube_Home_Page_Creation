...
import { PageHeaderFirstSection } from "./PageHaeder"
...
export default function SideBar() {
    ...
    return (
        <>
            ...
            <aside className={`w-56 lg:sticky absolute top-0 overflow-y-auto scrollbar-hidden pb-4 flex-col gap-2 px-2 ${isLargeOpen ? "lg:flex" : "lg:hidden"
            ...
            >
                ...
                <LargeSidebarSection visbleItemCount={1}>
...
type LargeSidebarSectionProps = {
    children: ReactNode,
    title: string,
    visbleItemCount?: number
}

function LargeSidebarSection({ children, title, visbleItemCount = Number.POSITIVE_INFINITY, }): LargeSidebarSectionProps {
    const [isExpanded, setIsExpanded] = useState(false)
    const childrenArray = Children.toArray(children).flat()
    const showExpandedButton = childrenArray.length > visbleItemCount
    const visibleChildren = isExpanded
        ? childrenArray
        : childrenArray.slice(0, visbleItemCount)
